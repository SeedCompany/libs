...
describe('parseScripture', () => {
  ...
  it.each([
    ...
    ['Genesis 100', 'Genesis has 50 chapter(s), not 100'],
    ['Genesis 1-100', 'Genesis has 50 chapter(s), not 100'],
    ['Genesis 1:100', 'Genesis 1 has 31 verse(s), not 100'],
    ['Genesis 1-2:100', 'Genesis 2 has 25 verse(s), not 100'],
    [
      '1-1',
